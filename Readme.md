#README
OVN-Flow Version 1.0.1 | Linux Command-Line OpenVPN Client | Declan Eaton 

Requirements:
* Ensure you have the OpenVPN Package installed on your device.
* This Script can only be run with sudo privileges. Please enter this when prompted. 
Description:
...
To use this Client. Simply move the script provided to usr/local/bash. Rename the file from onvf.sh to ovnf. Following this, use chmod +x /usr/local/bash/ovnf to make the script executable.
